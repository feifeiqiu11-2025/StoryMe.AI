...
Chinese Translation:`;
  ...
  const completion = await deepseek.chat.completions.create({
    ...
    messages: [
      {
        role: 'system',
        content: '你是专业的儿童故事翻译专家，擅长将英文故事翻译成生动、适合儿童的中文。请注意：Connor 翻译为"康浩"，Carter 翻译为"康乐"，Lily 翻译为"莉莉"，Dr. Lily 翻译为"莉莉医生"，KindleWood 保持英文不翻译。'
      },
      {
        role: 'user',
...
/**
 * Generate Chinese captions for "Dr. Lily" story
 */
async function generateDrLilyChinese() {
  const projectId = '70c9fca2-a70a-4643-ae23-d393122d0c5c'; // Dr. Lily story ID

  console.log('\n🚀 Starting Chinese caption generation for "Dr. Lily" story...\n');
  ...
  if (error || !project) {
    console.error('❌ Error fetching Dr. Lily story:', error);
    return;
  }
  ...
  console.log('\n' + '='.repeat(100));
  console.log('📊 TRANSLATION REVIEW - "Dr. Lily" Story');
