...
/**
 * Generate Chinese captions for "Firefighters" story
 */
async function generateFirefightersChinese() {
  const projectId = 'c585a2d8-9163-4136-adc3-b6e7a26f492a'; // Firefighters story ID

  console.log('\n🚀 Starting Chinese caption generation for "Firefighters" story...\n');
  ...
  if (error || !project) {
    console.error('❌ Error fetching Firefighters story:', error);
    return;
  }
  ...
  console.log('\n' + '='.repeat(100));
  console.log('📊 TRANSLATION REVIEW - "Firefighters" Story');
