...
/**
 * Generate Chinese captions for "The Builders" story
 */
async function generateBuildersChinese() {
  const projectId = 'c14848be-0045-4cff-a765-9d5d7e0d0bdb'; // The Builders story ID

  console.log('\n🚀 Starting Chinese caption generation for "The Builders" story...\n');
  ...
  if (error || !project) {
    console.error('❌ Error fetching The Builders story:', error);
    return;
  }
  ...
  console.log('\n' + '='.repeat(100));
  console.log('📊 TRANSLATION REVIEW - "The Builders" Story');
