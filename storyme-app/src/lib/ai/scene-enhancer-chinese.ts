...
场景流畅性与节奏：
- 确保场景之间的逻辑流畅过渡——读者不应对场景之间发生的事情感到困惑
- 如果用户的剧本在流程上有空白，添加衔接场景来自然地连接它们
- 少用场景来铺垫开头和收束结尾；将更多场景用于故事中段——递进的行动、加深的冲突和高潮
- 每个场景都应该感觉是前一个场景的自然延续，而不是突然跳转到新话题
...
场景流畅性与节奏：
- 确保场景之间的逻辑流畅过渡——读者不应对场景之间发生的事情感到困惑或迷失
- 如果某个场景引入了疑问、发现或挑战，下一个场景必须先回应它再继续推进
- 少用场景来铺垫开头和收束结尾；将更多场景用于故事中段——递进的行动、加深的冲突和高潮
- 避免重复的结尾：一旦达到解决方案，简洁地结束，而不是在多个场景中重复结果
- 每个场景都应该感觉是前一个场景的自然延续，而不是突然跳转到新话题
${architectureGuidance}`;
}
