// LEGACY — full-screen recorder, commented out (not deleted) per request 2026-05-23.
// The active recorder is components/audio/Recorder.tsx, used by both the picture book
// dashboard and chapter book dashboard. This file is retained for reference; if you
// need to restore it, uncomment by stripping the leading `// ` from each line below.
//
// To prevent stale imports from breaking compilation, this file exports a no-op stub.

export default function AudioRecorderLegacy(): null {
  return null;
}
