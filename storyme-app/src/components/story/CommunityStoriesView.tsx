 ...
 * Shared body for /stories (public) and /community-stories (dashboard).
 * Owns search, filter, sort, grid, pagination, and the featured carousel.
 */
...
export default function CommunityStoriesView() {
  ...
  // Debounce search input -> searchQuery (400ms after last keystroke).
  // Enter key fires immediately (handled inline on the input).
  useEffect(() => {
  ...
  // Featured stories appear in their own carousel at the top of the All Stories view.
  // Inside the grid they keep API ordering (newest or popular by sortBy) and just get a star icon.
  // Hide carousel as soon as the user starts typing (don't wait for debounce).
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          {(selectedTags.length > 0 || searchInput || searchQuery || selectedCustomTag) && (
            <button
