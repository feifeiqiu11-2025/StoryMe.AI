 ...
 *
 * WritingCoachContent — Pure content card (no overlay). Used as:
 *   - Desktop: inline side panel next to script textarea
 *   - Mobile: placed inside a modal overlay by the parent
 *
 * WritingCoachModal (commented out below) — Old modal version, kept for rollback.
 */
...
interface WritingCoachContentProps {
  onClose: () => void;
  script: string;
...
/**
 * WritingCoachContent — Pure content card component.
 * Renders header, scrollable coaching content, and footer.
 * Parent controls positioning (inline panel or modal overlay).
 */
...
/* =============================================================================
 * OLD MODAL VERSION — Commented out for rollback if needed.
 * To restore: uncomment below, remove WritingCoachContent above,
 * and update create/page.tsx to use <WritingCoachModal isOpen={...} /> again.
 * =============================================================================
 *
 ...
 *   // ... same state and logic as WritingCoachContent above ...
 *
 ...
 *         onClick={onClose}
 *       />
 *       {/* Modal card — same content as WritingCoachContent *\/}
