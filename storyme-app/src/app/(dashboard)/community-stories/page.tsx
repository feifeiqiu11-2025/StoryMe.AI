 ...
 * For logged-in users - uses dashboard layout with header
 * Displays public stories gallery with filters and search
 */
          ...
          <div className="flex-1 w-full">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900"
              />
              <svg
