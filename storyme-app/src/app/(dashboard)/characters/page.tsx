...
export default function CharactersPage() {
  ...
  // Sketch guide state
  // Vestigial: the standalone sketch-guide flow was superseded by the Coloring/Sketch
  // art style in CharacterPreviewStudio. Kept only so existing save/seed code compiles;
  // nothing populates it anymore.
